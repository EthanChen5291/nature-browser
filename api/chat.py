"""Vercel serverless function: a plain conversational assistant.

Mirrors the /api/chat endpoint from server.py. Lets Dad ask any question and
get a warm, clear answer. Same provider rules as summaries: Groq is preferred
(free, no card); Gemini is used if only that key is set. The key lives in a
Vercel environment variable, never in the browser.
"""
